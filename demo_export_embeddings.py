...
## SHORT NOT ALIGNED
python3 demo_export_embeddings.py ./pth/IR_50_MODEL_centerloss_casia_epoch16.pth ./data/golovan_demo_not_aligned/ \
--is_aligned 0 \
--with_demo_images 1 \
--image_size 112 \
--image_batch 5 \
...
## ALL FAMILY
python3 demo_export_embeddings.py ./pth/IR_50_MODEL_cosface_casia_epoch26_lfw9895.pth ./data/golovan_112/ \
--is_aligned 1 \
--with_demo_images 1 \
--image_size 112 \
--image_batch 5 \
--embeddings_name embeddings_cosface_1.npy \
--labels_name labels_cosface_1.npy \
