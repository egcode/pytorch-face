...
def main(ARGS):
    ...
    with torch.no_grad():
        ...
        feats_1 = extract_feature(ARGS.image_one_path, model, ARGS.model)
        feats_1 = feats_1.cpu().numpy()
        ...
        feats_2 = extract_feature(ARGS.image_two_path, model, ARGS.model)
        feats_2 = feats_2.cpu().numpy()
...
def distance(embeddings1, embeddings2, distance_metric):
...
def parse_arguments(argv):
    ...
    parser.add_argument('--distance_metric', type=int, help='Type of distance metric to use. 0: Euclidian, 1:Cosine similarity distance.')
